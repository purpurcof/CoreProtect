        ...
        try {
            ...
            if (found) {
                ...
                if (rowMax > count && count > 0) {
                    result.add(Phrase.build(Phrase.PREFIX) + Phrase.build(Phrase.NO_RESULTS_PAGE, Selector.SECOND));
                }
                else {
                    result.add(Phrase.build(Phrase.PREFIX) + Phrase.build(Phrase.NO_DATA_LOCATION, Selector.SECOND));
                }
            }
