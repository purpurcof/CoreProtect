        ...
        try {
            ...
            if (found) {
                ...
                if (rowMax > count && count > 0) {
                    result = Phrase.build(Phrase.PREFIX) + Phrase.build(Phrase.NO_RESULTS_PAGE, Selector.SECOND);
                }
                else {
                    result = Phrase.build(Phrase.PREFIX) + Phrase.build(Phrase.NO_DATA_LOCATION, Selector.THIRD);
                }
            }
